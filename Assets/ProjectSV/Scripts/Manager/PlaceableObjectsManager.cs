...
public class PlaceableObjectsManager : SingletonBase<PlaceableObjectsManager>
{
    ...
    {
        Debug.Log("PlaceableObjectsManager - Initialize() ȣ��");
    ...
    {
        Debug.Log("PlaceableObjectsManager - InitializeScene() ȣ��");
    ...
    private void VisualizePlacedObject(PlacedItem placedItem)
    {
        ...
        // Debug.Log($"VisualizePlacedObject �Լ� ȣ�� - {placedItem.Position} -> {go.transform.position}");
